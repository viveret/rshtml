...
pub trait IMathBinaryFn {
    fn math_fn(&self, v: f32, a: f32) -> f32;
    fn math_fn_name(&self) -> &str;
}

pub trait IMathBinaryFnNode: INode {
    fn math_fn(&self) -> Rc<dyn IMathBinaryFn>;
}

pub struct MathBinaryFnNode {
    math_fn_to_use: Rc<dyn IMathBinaryFn>,
...
impl MathBinaryFnNode {
    pub fn sin() -> Self {
        Self {
            math_fn_to_use: Rc::new(PowFn {}),
...
impl INode for MathBinaryFnNode {
    ...
    fn update(&self) {
        ...
        let new_value = self.math_fn_to_use.math_fn(v1, v2);
    ...
    fn set_input(&self, _: f32) {
        unimplemented!("MathBinaryFnNode does not have single input")
    }
    ...
    fn get_type_id(&self) -> TypeId {
        TypeId::of::<MathBinaryFnNode>()
    }

    fn get_type_name(&self) -> &str {
        nameof::name_of_type!(MathBinaryFnNode)
    }
...
impl IMathBinaryFnNode for MathBinaryFnNode {
    fn math_fn(&self) -> Rc<dyn IMathBinaryFn> {
