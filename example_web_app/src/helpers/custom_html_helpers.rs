...
//     fn form<'b, F>(&self, method: http::method::Method, action: std::borrow::Cow<'b, str>, html_attrs: Option<&HashMap<String, String>>, inner_render_fn: F) -> HtmlString where F: Fn() -> HtmlString {
