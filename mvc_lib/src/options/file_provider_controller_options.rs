...
//     // create a new WwwRootProviderControllerOptions struct from a list of directories to serve files from and a list of files to serve mapped to their aliases.
//     // serving_directories: the directories to serve files from.
//     // serving_files: the files to serve mapped to their aliases.
//     // returns: a new WwwRootProviderControllerOptions struct.
//     pub fn new(
...
//     //     serving_files: &'static phf::Map<&'static str, &'static str>
//     // ) -> Box<dyn Any> {
//     //     Box::new(Rc::new(Self::new(serving_directories, serving_files)) as Rc<dyn IWwwRootProviderControllerOptions>)
//     // }
