...
pub trait IRustToRustHtmlConverter {
    ...
    fn parse_identifier_expression(self: &Self, add_first_ident: bool, identifier: &Ident, identifier_token: &TokenTree, output: &mut Vec<RustHtmlToken>, it: Rc<dyn IPeekableTokenTree>, is_raw_tokenstream: bool) -> Result<(), RustHtmlError>;
    ...
    fn convert_html_ident_to_rusthtmltoken(self: &Self, ident: &Ident, ctx: &mut HtmlTagParseContext, output: &mut Vec<RustHtmlToken>, it: Rc<dyn IPeekableTokenTree>, is_raw_tokenstream: bool) -> Result<(), RustHtmlError>;
    fn convert_html_punct_to_rusthtmltoken(self: &Self, punct: &Punct, ctx: &mut HtmlTagParseContext, output: &mut Vec<RustHtmlToken>, it: Rc<dyn IPeekableTokenTree>, is_raw_tokenstream: bool) -> Result<bool, RustHtmlError>;
    fn convert_html_literal_to_rusthtmltoken(self: &Self, literal: &Literal, parse_ctx: &mut HtmlTagParseContext, output: &mut Vec<RustHtmlToken>, is_raw_tokenstream: bool) -> Result<(), RustHtmlError>;
