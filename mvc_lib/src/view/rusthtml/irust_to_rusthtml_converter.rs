...
pub trait IRustToRustHtmlConverter: IRustHtmlParserAssignSharedParts {
    ...
    fn parse_identifier_expression(self: &Self, add_first_ident: bool, identifier: &Ident, identifier_token: &TokenTree, last_token_was_ident: bool, output: &mut Vec<RustHtmlToken>, it: Rc<dyn IPeekableTokenTree>, is_raw_tokenstream: bool, ct: Rc<dyn ICancellationToken>) -> Result<(), RustHtmlError>;
    ...
    fn peek_path_str(self: &Self, context: Rc<dyn IRustHtmlParserContext>, identifier: &Ident, ident_token: &TokenTree, it: Rc<dyn IPeekableTokenTree>, is_raw_tokenstream: bool, ct: Rc<dyn ICancellationToken>) -> Result<String, RustHtmlError>;
    fn next_path_str(self: &Self, context: Rc<dyn IRustHtmlParserContext>, identifier: &Ident, ident_token: &TokenTree, it: Rc<dyn IPeekableTokenTree>, is_raw_tokenstream: bool, ct: Rc<dyn ICancellationToken>) -> Result<String, RustHtmlError>;
    ...
    fn convert_html_ident_to_rusthtmltoken(self: &Self, ident: &Ident, ctx: Rc<dyn IHtmlTagParseContext>, output: &mut Vec<RustHtmlToken>, it: Rc<dyn IPeekableTokenTree>, is_raw_tokenstream: bool, ct: Rc<dyn ICancellationToken>) -> Result<(), RustHtmlError>;
    fn convert_html_punct_to_rusthtmltoken(self: &Self, punct: &Punct, ctx: Rc<dyn IHtmlTagParseContext>, output: &mut Vec<RustHtmlToken>, it: Rc<dyn IPeekableTokenTree>, is_raw_tokenstream: bool, ct: Rc<dyn ICancellationToken>) -> Result<bool, RustHtmlError>;
    fn convert_html_literal_to_rusthtmltoken(self: &Self, literal: &Literal, parse_ctx: Rc<dyn IHtmlTagParseContext>, output: &mut Vec<RustHtmlToken>, is_raw_tokenstream: bool, ct: Rc<dyn ICancellationToken>) -> Result<(), RustHtmlError>;
    ...
    fn convert_rust_entry_to_rusthtmltoken(self: &Self, c: char, punct: Punct, is_in_html_mode: bool, output: &mut Vec<RustHtmlToken>, it: Rc<dyn IPeekableTokenTree>, is_raw_tokenstream: bool, ct: Rc<dyn ICancellationToken>) -> Result<(), RustHtmlError>;
    ...
    fn convert_rust_directive_group_to_rusthtmltoken(self: &Self, group: Group, prefix_token_option: Option<RustHtmlToken>, output: &mut Vec<RustHtmlToken>, is_raw_tokenstream: bool, ct: Rc<dyn ICancellationToken>) -> Result<(), RustHtmlError>;
    ...
    fn next_and_parse_html_tag(self: &Self, token_option: &TokenTree, ctx: Rc<dyn IHtmlTagParseContext>, output: &mut Vec<RustHtmlToken>, it: Rc<dyn IPeekableTokenTree>, is_raw_tokenstream: bool, ct: Rc<dyn ICancellationToken>) -> Result<bool, RustHtmlError>;
    ...
    fn on_kvp_defined(self: &Self, ctx: Rc<dyn IHtmlTagParseContext>) -> Result<(), RustHtmlError>;
