...
pub trait IRustToRustHtmlConverter {
    ...
    fn parse_identifier_expression(self: &Self, identifier: Ident, output: &mut Vec<RustHtmlToken>, it: Rc<dyn IPeekableTokenTree>) -> Result<(), RustHtmlError>;
    ...
    fn convert_path_str(self: &Self, identifier: Ident, it: Rc<dyn IPeekableTokenTree>) -> Result<String, RustHtmlError>;
    fn convert_string_or_ident(self: &Self, it: Rc<dyn IPeekableTokenTree>) -> Result<RustHtmlIdentAndPunctAndGroupOrLiteral, RustHtmlError>;
    ...
    fn convert_html_ident_to_rusthtmltoken(self: &Self, ident: &Ident, ctx: &mut HtmlTagParseContext, output: &mut Vec<RustHtmlToken>, it: Rc<dyn IPeekableTokenTree>) -> Result<(), RustHtmlError>;
    fn convert_html_punct_to_rusthtmltoken(self: &Self, punct: &Punct, ctx: &mut HtmlTagParseContext, output: &mut Vec<RustHtmlToken>, it: Rc<dyn IPeekableTokenTree>) -> Result<bool, RustHtmlError>;
    fn convert_html_literal_to_rusthtmltoken(self: &Self, literal: &Literal, parse_ctx: &mut HtmlTagParseContext, output: &mut Vec<RustHtmlToken>) -> Result<(), RustHtmlError>;
    ...
    fn convert_group_to_rusthtmltoken(self: &Self, group: Group, is_in_html_mode: bool, output: &mut Vec<RustHtmlToken>, is_raw_tokenstream: bool) -> Result<(), RustHtmlError>;
    ...
    fn on_kvp_defined(self: &Self, ctx: &mut HtmlTagParseContext, output: &mut Vec<RustHtmlToken>);
