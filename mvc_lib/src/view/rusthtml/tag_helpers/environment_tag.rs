...
impl IHtmlTagParsed for EnvironmentHtmlTagParsed {
    ...
    fn on_tag_parsed(&self, tag_context: &HtmlTagParseContext, _html_context: Rc<dyn IRustHtmlParserContext>, _output: &mut Vec<RustHtmlToken<Ident, Punct, Literal>>) -> Result<bool, RustHtmlError> {
