...
RouteValuesBuilder; pub struct view_dev_controllers
{
...
} impl view_dev_controllers
{
    pub fn new() -> Self
    {
        Self
        {
            ...
            parse_from_rfc2822("Mon, 16 Sep 2024 02:51:54 +0000").expect("could not parse when compiled").into(),
        }
...
} impl IView for view_dev_controllers
{
    ...
    IServiceCollection) -> Result < HtmlString, RustHtmlError >
    {
        ...
        model.controllers.iter()
        {
            ...
            Some(&RouteValuesBuilder::build_area(&controller.name))); <li>
