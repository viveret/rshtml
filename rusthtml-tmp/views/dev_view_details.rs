...
RouteValuesBuilder; pub struct view_dev_view_details
{
...
} impl view_dev_view_details
{
    pub fn new() -> Self
    {
        Self
        {
            ...
            parse_from_rfc2822("Mon, 16 Sep 2024 02:52:29 +0000").expect("could not parse when compiled").into(),
        }
