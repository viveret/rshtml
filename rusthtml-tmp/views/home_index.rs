...
ServiceCollectionExtensions; pub struct view_home_index
{
...
} impl view_home_index
{
    pub fn new() -> Self
    {
        Self
        {
            ...
            : DateTime ::
            parse_from_rfc2822("Tue, 01 Oct 2024 23:59:28 +0000").expect("could not parse when compiled").into(),
        }
...
} impl IView for view_home_index
{
    ...
    IServiceCollection) -> Result < HtmlString, RustHtmlError >
    {
        ...
        html_output.write_html(HtmlString ::
        from({ view_context.get_markdown_file_nocache("README.md") }));
