...
} impl view_learn_index
{
    pub fn new() -> Self
    {
        Self
        {
            ...
            parse_from_rfc2822("Thu, 13 Mar 2025 16:49:36 +0000").expect("could not parse when compiled").into(),
        }
...
} impl IView for view_learn_index
{
