...
mvc_macro_lib::rusthtml_view_macro! {
    ...
    @name "authroles_add"
    @model crate::view_models::authroles::add::AddViewModel
    @inject crate::helpers::custom_html_helpers::CustomHtmlHelpers::<crate::view_models::authroles::add::AddViewModel>: custom_html
    @{
